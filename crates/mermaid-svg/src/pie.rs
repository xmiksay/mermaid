...
use mermaid_parse::PieDiagram;

use crate::svg::{escape, fnum, SvgBuilder};
use crate::theme::{pie_color, FG, FG_MUTED};
...
fn legend_text(e: &mermaid_parse::PieEntry, total: f64, show_data: bool) -> String {
    if show_data {
